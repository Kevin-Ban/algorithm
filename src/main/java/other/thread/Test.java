...
public class Test {
    ...
    public static void threadTest() throws InterruptedException {
        ...
        Thread test1 = new Thread(new RunableTest(lock, condition));
        Thread test2 = new Thread(new RunableTest(lock, condition));
        Thread test3 = new Thread(new RunableTest(lock, condition));
        test1.start();
        test2.start();
        test3.start();
        Thread.sleep(1);
    ...
    public static void runnableTest() throws InterruptedException {
        Thread t = new Thread(new RunableTest(null, null));
        t.start();
        // 主线程sleep 1毫秒，让出资源执行其他线程
        Thread.sleep(1);
    }
